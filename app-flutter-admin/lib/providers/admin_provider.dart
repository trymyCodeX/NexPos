import 'package:flutter/material.dart';
  ...
  class AuthProvider extends ChangeNotifier {
    ...
    // BUG FIX: server menggunakan PUT /api/auth/change-password dengan field 'currentPassword'
    // Sebelumnya menggunakan POST dan mengirim field 'oldPassword' yang tidak dikenali server
  ...
  class NotificationProvider extends ChangeNotifier {
    ...
    // BUG FIX: endpoint pengiriman notifikasi dari super admin ada di /api/super-admin/notifications
    // bukan /api/notifications (yang hanya untuk GET notifikasi milik user sendiri)
    Future<bool> sendToOwner(String ownerId, String title, String message, String type) async {
      try {
        final token = await _session.getToken();
        await _api.post('/api/super-admin/notifications', {
          'ownerId': ownerId,
          'title': title,
          'message': message,
          'type': type,
